...
namespace BMEffects_Remaster.Effects.Projectiles
{
    internal class SM_LightController : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            child = UnityEngine.Object.Instantiate<GameObject>(global::BMEffects_Remaster.BMEffects_Remaster.GetAsset("LightChild"), transform);
        ...
        public void Update()
        {
            if (transform.parent.GetComponent<SM_AutoKill>() && transform.parent.GetComponent<SM_AutoKill>().nowInit)
            {
                Init();
            }
